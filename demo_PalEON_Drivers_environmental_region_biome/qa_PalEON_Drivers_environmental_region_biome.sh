####################################################################
#### modify biome_potential_vegtype_biome.nc
cd /ingestdata/dataqa/nacp/NACP_PalEON_MIP/analysis/working/data/PalEON_Drivers_environmental_region/biome  ## change to your working directory
...
cd /ingestdata/dataqa/nacp/NACP_PalEON_MIP/analysis/working/data/PalEON_Drivers_environmental_region/biome  ## change to you working directory
